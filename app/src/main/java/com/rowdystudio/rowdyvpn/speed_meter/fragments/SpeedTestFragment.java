...
import static com.rowdystudio.rowdyvpn.speed_meter.utils.LogUtils.LOGI;
import static com.rowdystudio.rowdyvpn.speed_meter.utils.LogUtils.makeLogTag;
...
import com.rowdystudio.rowdyvpn.speed_meter.custom_ui.TickProgressBar;
import com.rowdystudio.rowdyvpn.speed_meter.utils.ConnectionDetector;
import com.rowdystudio.rowdyvpn.speed_meter.utils.GetSpeedTestHostsHandler;
import com.rowdystudio.rowdyvpn.speed_meter.utils.test.HttpDownloadTest;
import com.rowdystudio.rowdyvpn.speed_meter.utils.test.HttpUploadTest;
import com.rowdystudio.rowdyvpn.speed_meter.utils.test.PingTest;
...
public class SpeedTestFragment extends Fragment {
				...
				if (mInterstitialAd != null) {
					...
					mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
						...
						public void onAdDismissedFullScreenContent() {
							...
							if(testing){
								tostErr(requireContext(),"Please Wait..");
							}else {
								testing = true;
								testSpeed ();
							}
		...
		new Thread (() -> {
			...
			if (info != null) {
				if (info.size () > 0) {
					...
					try {
						getActivity ().runOnUiThread (() -> {
							tostSucc(requireContext(),"Finished..");
							tvBegin.setImageResource (R.drawable.ic_play);
							testing = false;
							LOGE ("TAG", "test1");
	 ...
	 */
	public static class getTrainResponseHandler extends AsyncHttpResponseHandler {
