...
public class LaunchVPN extends Activity {
    ...
    public static final String EXTRA_KEY = "de.blinkt.maxcloud.shortcutProfileUUID";
    public static final String EXTRA_NAME = "de.blinkt.maxcloud.shortcutProfileName";
    public static final String EXTRA_HIDELOG = "de.blinkt.maxcloud.showNoLogWindow";
    ...
    void showConfigErrorDialog(int vpnok) {
        ...
        d.setMessage(vpnok);
        d.setPositiveButton(android.R.string.ok, (dialog, which) -> finish());
