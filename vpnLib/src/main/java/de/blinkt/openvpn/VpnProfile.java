...
public class VpnProfile implements Serializable, Cloneable {
    ...
    public static final String EXTRA_PROFILEUUID = "de.blinkt.maxcloud.profileUUID";
    ...
    public final static String DEFAULT_DNS1 = "8.8.8.8";
    public final static String DEFAULT_DNS2 = "8.8.4.4";
    // variable named wrong and should haven beeen transient
    // but needs to keep wrong name to guarante loading of old
    // profiles
    public transient final boolean profileDeleted = false;
    ...
    public String mServerName = "maxcloud.example.com";
    ...
    private byte[] processSignJellyBeans(PrivateKey privkey, byte[] data, boolean pkcs1padding) {
        try {
            Method getKey = Objects.requireNonNull(privkey.getClass().getSuperclass()).getDeclaredMethod("getOpenSSLKey");
