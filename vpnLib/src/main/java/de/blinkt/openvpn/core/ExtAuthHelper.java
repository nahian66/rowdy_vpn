...
public class ExtAuthHelper {
    ...
    public static final String ACTION_CERT_CONFIGURATION = "de.blinkt.maxcloud.api.ExternalCertificateConfiguration";
    public static final String ACTION_CERT_PROVIDER = "de.blinkt.maxcloud.api.ExternalCertificateProvider";

    public static final String EXTRA_ALIAS = "de.blinkt.maxcloud.api.KEY_ALIAS";
    public static final String EXTRA_DESCRIPTION = "de.blinkt.maxcloud.api.KEY_DESCRIPTION";
