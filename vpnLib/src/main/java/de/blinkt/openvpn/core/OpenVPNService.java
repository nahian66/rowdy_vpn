...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    public static final String START_SERVICE = "de.blinkt.maxcloud.START_SERVICE";
    public static final String START_SERVICE_STICKY = "de.blinkt.maxcloud.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "de.blinkt.maxcloud.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "de.blinkt.maxcloud.DISCONNECT_VPN";
    ...
    private static final String PAUSE_VPN = "de.blinkt.maxcloud.PAUSE_VPN";
    private static final String RESUME_VPN = "de.blinkt.maxcloud.RESUME_VPN";

    public static final String EXTRA_CHALLENGE_TXT = "de.blinkt.maxcloud.core.CR_TEXT_CHALLENGE";
    public static final String EXTRA_CHALLENGE_OPENURL = "de.blinkt.maxcloud.core.OPENURL_CHALLENGE";
   ...
   public static String humanReadableByteCount(long bytes, boolean speed, Resources res) {
    ...
    synchronized void unregisterDeviceStateReceiver() {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: de.blinkt.maxcloud.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("de.blinkt.maxcloud.VPN_STATUS");
