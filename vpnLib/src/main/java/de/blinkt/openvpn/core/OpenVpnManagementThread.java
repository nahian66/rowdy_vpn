...
public class OpenVpnManagementThread implements Runnable, OpenVPNManagement {
    ...
    private static final String TAG = "maxcloud";
    ...
    public void run() {
        ...
        try {
            ...
            if (!Objects.equals(e.getMessage(), "socket closed") && !Objects.equals(e.getMessage(), "Connection reset by peer"))
                VpnStatus.logException(e);
        }
        synchronized (active) {
            active.remove(this);
    ...
    private void processPWCommand(String argument) {
        ...
        try {
            // Ignore Auth token message, already managed by maxcloud itself
